...
test('@smoke Browser Context fixture - Playwright Test', async ({ browser }) => {
...
test('@regression Page fixture - Playwright Test Dropdown', async ({ page }) => {
    await page.goto("https://rahulshettyacademy.com/loginpagePractise/");
...
test('@sanity Child Window Handling', async ({ browser }) => {
    const context = await browser.newContext();
    const page = await context.newPage();
